    ...
    return (
       <div className="about-container">
           ...
           <div className="contact">
               <span className="iconify" title="LinkedIn" data-icon="logos:linkedin" data-inline="false"/>
               <span className="iconify" title="GitHub" data-icon="logos:github" data-inline="false"/>
               <span className="iconify" title="Resume" data-icon="bx:bxs-file-pdf" data-inline="false"/>
           </div>
       </div>
    );
}
